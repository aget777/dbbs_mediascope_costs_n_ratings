...
'query' : """
            ...
            t5.adFirstIssueDate as first_issue_date, t5.media_type, t6.media_type_detail as media_type_long, 'new' as include_exclude
            from
            	(select * from media_ad_dict_view where cleaning_flag=2) t5
            	left join (select distinct adId, media_type_detail from media_costs_union_view) t6
            	on t5.adId=t6.adId
