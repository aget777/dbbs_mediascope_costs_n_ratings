...
def get_nat_tv_reports(ad_filter=False, start_date='', end_date='', flag='regular'):
    ...
    custom_cols_list = list(set(custom_cols_list) - set(['media_type', 'media_type_long', 'include_exclude', 'ad_id']))
...
# Если дата окончани загрузки НЕ задана, то мы считаем минус 3 дня от текущей даты
    ...
    for i in range(count_days+1):
        ...
        df_buying_final['media_type_long'] = 'tv_nat'
        ...
        # ad_filter=special_ad_filter - Кастомный фильтра, слздали его в начале этого файла
        ...
        df_simple_final['media_type_long'] = 'tv_nat'
...
# ad_filter = special_ad_filter 
# date_filter = [('2024-03-01', '2024-03-01')]
